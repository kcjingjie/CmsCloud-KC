package com.kc.oauth2.common.service.impl;

import cn.hutool.core.collection.CollectionUtil;
import com.kc.common.constant.CommonConstant;
import com.kc.common.model.SysPermission;
import com.kc.oauth2.common.properties.SecurityProperties;
import com.kc.oauth2.common.service.IPermissionService;
import com.kc.oauth2.common.util.AuthUtils;
...
public abstract class DefaultPermissionServiceImpl implements IPermissionService {
     ...
     * @return
     */
    public abstract List<SysPermission> findMenuByRoleCodes(String roleCodes);
    ...
    public boolean hasPermission(HttpServletRequest request, Authentication authentication) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            List<SysPermission> menuList = findMenuByRoleCodes(roleCodes);
            for (SysPermission menu : menuList) {
                if (StringUtils.isNotEmpty(menu.getUri())
                        && antPathMatcher.match(menu.getValue(), request.getRequestURI()
                        )) {
                    return true;
                }
            }
