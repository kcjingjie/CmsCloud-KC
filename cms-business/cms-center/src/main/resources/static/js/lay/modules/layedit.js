...
layui.define(['layer', 'form'], function(exports){
    ...
    var body = this, index = layer.open({
      ...
      ,content: ['<ul class="layui-form" style="margin: 15px;">'
        ...
        ,'<li class="layui-form-item">'
          ...
          ,'</div>'
        ,'</li>'
        ,'<li class="layui-form-item" style="text-align: portal;">'
  ...
  ,tools = {
    ...
    ,center: '<i class="layui-icon layedit-tool-portal" title="居中对齐" lay-command="justifyCenter" layedit-event="portal"">&#xe647;</i>'
