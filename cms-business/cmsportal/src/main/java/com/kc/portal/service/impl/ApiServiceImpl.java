package com.kc.portal.service.impl;
...
import com.kc.portal.config.WxMaConfiguration;
...
import com.kc.portal.mapper.*;
import com.kc.portal.model.ContentInfo;
import com.kc.portal.model.UserInfo;
import com.kc.portal.entity.SysCode;
import com.kc.portal.entity.dto.IndexListDTO;
import com.kc.portal.model.CommentInfo;
import com.kc.portal.model.UserCollectInfo;
import com.kc.portal.service.ApiService;
import com.kc.portal.utils.JWTUtil;
import com.kc.portal.utils.MD5Utils;
import com.kc.portal.utils.SensitiveWordFilter;
...
//            e.printStackTrace();
    ...
    public TokenVO miniAppLogin(String share_user_id, String code, String user_info, String encrypted_data, String iv, String signature) {
        ...
        try {
            ...
            redisUtil.setEx(String.format(RedisKeyConstans.TOKEN, userInfo.getId()), token, 1, TimeUnit.DAYS);
...
//            e.printStackTrace();
    ...
    public LoginVO register(String mobile, String nickname, String password, String verify_code) {
        Boolean hasKey = redisUtil.hasKey(String.format(RedisKeyConstans.VERIFY_CODE, mobile, verify_code));
        if (hasKey) {
            UserInfo userInfo = userInfoMapper.getByMobile(mobile);
            if (!ObjectUtils.isEmpty(userInfo)) {
    ...
    public Integer logout() {
        try {
            Long userId = JWTUtil.getUserId();
            redisUtil.delete(String.format(RedisKeyConstans.TOKEN, userId));
        } catch (Exception e) {
            return 0;
        }
        return 0;
